...
'sentences' => [
    ...
    'cam_distance:full-body'           => 'full-body shot, head to feet entirely in frame',
    ...
    'cam_angle:from-behind'         => 'shot from behind, over the shoulder',
    ...
    'cam_effect:silhouette'          => 'backlit silhouette shot, reduced to outlines',

    // ---------- pencahayaan ----------
    'lighting:ring-spotlight' => 'A hard overhead spotlight isolates the ring, everything beyond it falling into black.',
    'lighting:dramatic'       => 'Strong backlight from behind, throwing deep shadows across the canvas.',
