<!DOCTYPE html>
{{-- Bahasa halaman depan ditentukan pilihan pembacanya, bukan locale
     aplikasi: alat di baliknya berbahasa Indonesia, halaman depannya tidak. --}}
<html lang="{{ $lang ?? str_replace('_', '-', app()->getLocale()) }}" class="dark" data-hemat="0">
    <head>
        <meta charset="utf-8">
